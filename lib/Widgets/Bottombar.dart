...
//     // Get GetXRoleController instance
...
//
//       // Update WorkerMyHireScreen with categoryId and subCategoryId
...
//             BottomNavigationBarItem(
//               // icon: ImageIcon(AssetImage('assets/images/home.png'), size: 24),
//               icon: SvgPicture.asset('assets/svg_images/bottombar/home-2.svg',height: 24,),
//               label: 'Home',
//             ),
//             BottomNavigationBarItem(
//               icon: SvgPicture.asset('assets/svg_images/bottombar/task-square.svg',height: 24,),
//               // icon: ImageIcon(AssetImage('assets/images/Message.png'), size: 24),
//               label: 'My Hire',
//             ),
//             BottomNavigationBarItem(
//               icon: ImageIcon(AssetImage('assets/images/Job.png'), size: 24),
//               // icon: SvgPicture.asset('assets/svg_images/bottombar/myworkicon.svg',height: 28,color: Colors.red,),
//               label: 'My Work',
//             ),
//             BottomNavigationBarItem(
//               // icon: ImageIcon(AssetImage('assets/images/Work.png'), size: 24),
//               icon: SvgPicture.asset('assets/svg_images/bottombar/messages.svg',height: 24,),
//               label: 'Message',
//             ),
//             BottomNavigationBarItem(
//               // icon: ImageIcon(AssetImage('assets/images/Account.png'), size: 24),
//               icon: SvgPicture.asset('assets/svg_images/bottombar/profile-circle.svg',height: 24,),
//               label: 'Account',
//             ),
//           ],
//         ),
