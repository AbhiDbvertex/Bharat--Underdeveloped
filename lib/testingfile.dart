...
//             print("Abhi:- Image removed at index $index in StandaloneChatDetailScreen");
//           });
//         },
//         onRemoveDocument: (index) {
//           setState(() {
//             documents.removeAt(index);
//             print("Abhi:- Document removed at index $index in StandaloneChatDetailScreen");
//           });
//         },
//       ),
//     );
...
//   final String userId;
//   final List<dynamic> messages;
//   final List<dynamic> onlineUsers; // Adjusted to List<String> based on your code
//   final ScrollController scrollController;
//   final TextEditingController messageController;
//   final List<String> images;
//   final List<String> documents;
...
//   final VoidCallback onPickDocuments;
//   final String Function(String) formatTime;
//   final Function(int)? onRemoveImage; // New callback for removing image
//   final Function(int)? onRemoveDocument; // New callback for removing document
//
//   const ChatDetailScreen({
//     Key? key,
//     required this.currentChat,
...
//   @override
//   Widget build(BuildContext context) {
//     print("Abhi:- Building ChatDetailScreen, conversationId: ${widget.currentChat['_id']}");
...
//     try {
//       if (members.isEmpty) {
//         print("Abhi:- Warning: Members list is empty for conversation ${widget.currentChat['_id']}");
//         otherUser = {'full_name': 'Unknown', '_id': '', 'profile_pic': null};
//         WidgetsBinding.instance.addPostFrameCallback((_) {
//           ScaffoldMessenger.of(context).showSnackBar(
//             SnackBar(content: Text('Warning: No members found in conversation')),
...
//       } else if (members[0] is String) {
//         print("Abhi:- Members are IDs (strings), handling new conversation");
//         final otherId = members.firstWhere((m) => m != widget.userId, orElse: () => '');
//         otherUser = {'full_name': 'Unknown User', '_id': otherId, 'profile_pic': null};
//       } else {
//         otherUser = members.firstWhere(
//               (m) {
//             final memberId = m['_id']?.toString();
//             print("Abhi:- Comparing memberId: $memberId with userId: ${widget.userId}");
//             return memberId != null && memberId != widget.userId;
//           },
//           orElse: () {
//             print("Abhi:- No matching member found, using default");
//             return {'full_name': 'Unknown', '_id': '', 'profile_pic': null};
...
//     }
//
//     final isOnline = otherUser['_id'] != '' && widget.onlineUsers.contains(otherUser['_id'].toString());
//
//     return WillPopScope(
//       onWillPop: () async {
//         print("Abhi:- Back pressed in ChatDetailScreen");
...
//                                 children: [
//                                   Text(
//                                     widget.formatTime(msg['createdAt']),
//                                     style: TextStyle(
//                                       fontSize: 11,
//                                       color: isMe ? Colors.white70 : Colors.grey[600],
//                                     ),
...
//               ),
//             ),
//             if (widget.images.isNotEmpty || widget.documents.isNotEmpty)
//               Container(
//                 height: 80,
//                 color: Colors.white,
//                 child: ListView.builder(
//                   scrollDirection: Axis.horizontal,
//                   padding: EdgeInsets.symmetric(horizontal: 16, vertical: 8),
//                   itemCount: widget.images.length + widget.documents.length,
//                   itemBuilder: (context, index) {
//                     if (index < widget.images.length) {
//                       print("Abhi:- Rendering selected image: ${widget.images[index]}");
//                       return Stack(
//                         children: [
//                           Container(
//                             margin: EdgeInsets.only(right: 8),
...
//                                   print("Abhi:- Removed image at index: $index");
//                                 }
//                               },
//                               child: Container(
//                                 decoration: BoxDecoration(
...
//                       );
//                     } else {
//                       final docIndex = index - widget.images.length;
//                       print("Abhi:- Rendering selected document: ${widget.documents[docIndex]}");
//                       return Stack(
//                         children: [
//                           Container(
//                             margin: EdgeInsets.only(right: 8),
...
//                                 Icon(Icons.insert_drive_file, size: 24),
//                                 Text(
//                                   widget.documents[docIndex].split('/').last.substring(
//                                     0,
//                                     widget.documents[docIndex].split('/').last.length > 8
//                                         ? 8
//                                         : widget.documents[docIndex].split('/').last.length,
//                                   ),
//                                   style: TextStyle(fontSize: 8),
//                                   textAlign: TextAlign.center,
//                                 ),
...
//                             child: GestureDetector(
//                               onTap: () {
//                                 if (widget.onRemoveDocument != null) {
//                                   widget.onRemoveDocument!(docIndex);
//                                   print("Abhi:- Removed document at index: $docIndex");
//                                 }
//                               },
//                               child: Container(
//                                 decoration: BoxDecoration(
...
//           setState(() {
//             images.removeAt(index);
//             print("Abhi:- Image removed at index $index in ChatScreen");
//           });
//         },
//         onRemoveDocument: (index) {
//           setState(() {
//             documents.removeAt(index);
//             print("Abhi:- Document removed at index $index in ChatScreen");
//           });
//         },
//       );
//     }
