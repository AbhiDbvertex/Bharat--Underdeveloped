...
//   }
//   // Filter logic for bidders and related workers
//   void _filterLists() {
//     final query = _searchController.text.toLowerCase();
//     setState(() {
//       if (query.isEmpty) {
//         // If search query is empty, show all bidders and related workers
//         filteredBidders = bidders;
//         filteredRelatedWorkers = relatedWorkers;
//       } else {
//         // Filter bidders based on full_name or location
...
//         }).toList();
//
//         // Filter related workers based on full_name or location
...
//     final String url = 'https://api.thebharatworks.com/api/bidding-order/inviteServiceProviders';
...
//         Get.snackbar("Success", responseData['message'],snackPosition: SnackPosition.BOTTOM,backgroundColor: Colors.green,colorText: Colors.white,);
//       } else {
//         print("Abhi:- else Invideprovider response : ${response.body}");
//         Get.snackbar("Error", responseData['message'] ?? "Something went wrong",snackPosition: SnackPosition.BOTTOM,backgroundColor: Colors.red,colorText: Colors.white,);
//       }
//     } catch (e) {
...
//                                   _filterLists(); // Update filtered list
//                                 });
//                               },
//                               child: Container(
//                                 height: height * 0.045,
...
//                           Padding(
//                             padding: EdgeInsets.only(top: height * 0.01),
//                             child: filteredBidders == null || filteredBidders!.isEmpty
//                                 ? Center(
//                               child: SvgPicture.asset(
//                                 'assets/svg_images/nobidders.svg',
//                                 height: height * 0.33,
...
//                               shrinkWrap: true,
//                               physics: const NeverScrollableScrollPhysics(),
//                               itemCount: filteredBidders!.length,
//                               itemBuilder: (context, index) {
//                                 final bidder = filteredBidders![index];
...
//                             child: filteredRelatedWorkers == null || filteredRelatedWorkers!.isEmpty
//                                 ? Column(
//                               children: [
//                                 Center(
//                                   child: SvgPicture.asset(
...
//                                                   child: InkWell(
//                                                     onTap: () {
//                                                       inviteproviderId(workerId);
//                                                       print("Abhi:- tab on invite print workerId : $workerId");
//                                                     },
//                                                     child: Container(
//                                                       height: 32,
//                                                       constraints: BoxConstraints(
