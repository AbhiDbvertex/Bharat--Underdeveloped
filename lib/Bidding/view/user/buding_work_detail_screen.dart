...
class _BiddingWorkerDetailScreenState extends State<BiddingWorkerDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final assignedWorker = AssignedWorkerdata?['assignedWorker'] as Map<String, dynamic>?;


    print("Abhi:- buddingOderId is worker name: ${data?['assignedWorker']?['name'] }");
          ...
          body: Container(
            ...
            child: isLoading
              ...
              child: Column(
                ...
                data?['hire_status'] == 'accepted' ?  SizedBox(height: height*0.03,) : SizedBox(),
                  //             This is accepted time show this fileds
                  data?['hire_status'] == 'accepted' ?  Card(
                ...
                SizedBox(height: height * 0.02),
                  ...
                  data?['hire_status'] == 'accepted' ?  SizedBox() : SizedBox(height: height * 0.02) ,
                  data?['hire_status'] == 'pending' ?   Padding(
                    padding:
                    EdgeInsets.symmetric(horizontal: width * 0.05),
                    child: Container(
                  ...
                  data?['hire_status'] == 'pending' ?  SizedBox(height: height * 0.015) : SizedBox(),
                  data?['hire_status'] == 'pending' ?  Padding(
                    padding:
                    EdgeInsets.symmetric(horizontal: width * 0.05),
                    child: Column(
