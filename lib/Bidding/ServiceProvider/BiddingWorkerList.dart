...
// Screen
class BiddingWorkerList extends StatefulWidget {
  final String orderId;

  const BiddingWorkerList({Key? key, required this.orderId}) : super(key: key);

  @override
  _BiddingWorkerListState createState() => _BiddingWorkerListState();
}

class _BiddingWorkerListState extends State<BiddingWorkerList> {
