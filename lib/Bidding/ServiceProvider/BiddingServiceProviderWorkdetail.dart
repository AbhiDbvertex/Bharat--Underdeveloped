...
//                       print("assig person data ${biddingOrder?.assignedWorker?.name ?? "No data"}");
//                       print("assig person data ${biddingOrder?.assignedWorker?.image ?? "No data"}");
//                       print("assig person data ${biddingOrder?.assignedWorker?.address ?? "No data"}");
