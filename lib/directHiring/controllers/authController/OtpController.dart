...
// //         const SnackBar(
// //           content: Text("Bhai, sahi 4-digit OTP daal!"),
...
// //       print("Phone: $phone, OTP: $enteredOtp");
// //
...
// //         final role = data['role'] ?? 'none'; // Default to 'none' if role empty
// //
...
// //           await prefs.setBool('onboardingComplete', true); // ✅ Added line here
// //           await roleController.setRoleFromOtp(role); // Set role in controller
// //
// //           print(
// //             "✅ Token Saved: $token, Role: $role, Profile Complete: $isProfileComplete",
// //           );
// //
...
// //             print("🚀 Going to Bottombar for role: $role");
// //           } else {
// //             nextScreen = const RoleSelectionScreen();
// //             print("🚀 Going to RoleSelectionScreen, role: $role");
// //           }
// //
...
// //           ScaffoldMessenger.of(context).showSnackBar(
// //             SnackBar(
// //               content: Text(data['message'] ?? 'Galat OTP ya token nahi mila!'),
// //               backgroundColor: Colors.red,
// //             ),
// //           );
// //           print("❌ Error: ${data['message'] ?? 'Invalid OTP or token null'}");
// //         }
// //       } else {
// //         ScaffoldMessenger.of(context).showSnackBar(
...
// //       print('Sending phone number: ${model.phoneNumber.trim()}');
// //
// //       if (response.statusCode == 200) {
// //         final data = jsonDecode(response.body);
// //         final success = data['status'] == true;
...
// //
// //           ScaffoldMessenger.of(context).showSnackBar(
// //             SnackBar(content: Text('OTP bhej diya! Testing OTP: $newOtp')),
// //           );
// //         } else {
// //           ScaffoldMessenger.of(context).showSnackBar(
// //             SnackBar(
// //               content: Text(data['message'] ?? 'OTP bhejne mein dikkat!'),
// //               backgroundColor: Colors.red,
// //             ),
// //           );
// //         }
...
// //       } else {
// //         print('⚠️ category_id ya sub_category_id nahi mila');
// //       }
// //     } else {
...
//
//     if (enteredOtp.length != 4 || !RegExp(r'^\d{4}$').hasMatch(enteredOtp)) {
//       _showMessage(context, "Please enter a valid 4-digit OTP.");
//       return;
//     }
//
//     try {
...
//           }
//           _showMessage(
//               context, data['message'] ?? "OTP verify successfully");
//
//           Navigator.of(context, rootNavigator: true).pushAndRemoveUntil(
//             MaterialPageRoute(builder: (_) => nextScreen),
//                 (route) => false,
...
//         } else {
//           _showMessage(
//               context, data['message'] ?? "Invalid OTP or authentication failed.");
//         }
//       } else {
//         _showMessage(context, data['message'] ?? "Server error occurred. Please try again.");
//       }
//     } catch (e) {
//       print('❌ Network Error: $e');
...
//         } else {
//           _showMessage(context, data['message'] ?? "Failed to resend OTP. Please try again.");
//         }
//       } else {
//         _showMessage(context, data['message'] ?? "Server error occurred. Please try again.");
//       }
...
class OtpController {
  ...
  void _showMessage(String message) {
    // Use the GlobalKey to show SnackBar, ensuring stable reference
