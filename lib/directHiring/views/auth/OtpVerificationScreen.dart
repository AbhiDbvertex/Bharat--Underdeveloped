...
//
//     // Only show OTP for testing, don't auto-fill
//     if (widget.receivedOtp != null && widget.receivedOtp!.length == 4) {
//       controller.updateOtp(widget.receivedOtp!); // update model, not UI
//     }
//   }
//
//   @override
...
//
//                 // For testing only: show OTP, don't fill
//                 if (widget.receivedOtp != null)
//                   Padding(
//                     padding: const EdgeInsets.only(bottom: 12.0),
//                     child: Text(
//                       "Testing OTP: ${widget.receivedOtp}",
...
//
//                 GestureDetector(
//                   onTapDown: (_) => setState(() => _resendScale = 0.9),
//                   onTapUp: (_) {
...
//                     );
//                   },
//                   onTapCancel: () => setState(() => _resendScale = 1.0),
//                   child: AnimatedScale(
//                     scale: _resendScale,
