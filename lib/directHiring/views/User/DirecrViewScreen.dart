...
//       if (response.statusCode == 200) {
//         final jsonData = jsonDecode(response.body);
//         print("Abhi:-print get service provider data : ${response.body}");
//         setState(() {
//           providerDetail = jsonData['user']; // pura provider ka object
//         });
//       } else {
//         print("❌ Provider fetch failed: ${response.body}");
//         Get.snackbar(
...
//             )
//                 : SizedBox(),
//             //    this list is show only pending time
//
//            Flexible(
...
//   Widget build(BuildContext context) {
//     print("Abhi:- darect oder id ${widget.id}");
//     // print("Abhi:- darect oder id ${order!['hire_status']}");
//
//     return Scaffold(
//       appBar: AppBar(
//         backgroundColor: AppColors.primaryGreen,
...
//                                 GestureDetector(
//                                   onTap: () async {
//                                     final phone = order!['assignedWorker']?['phone'] ?? '';
//                                     if (phone.isNotEmpty) {
...
//                             InkWell(
//                               onTap: () {
//                                 if (order!['assignedWorker']?['_id'] != null) {
//                                   Navigator.push(
//                                     context,
//                                     MaterialPageRoute(
//                                       builder: (context) => WorkerListViewProfileScreen(
...
// }
               ...
               /// upar vaha code puri tara se sahi hai
