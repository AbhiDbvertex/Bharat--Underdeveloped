...
class _MyHireScreenState extends State<MyHireScreen> {
  ...
  Future<void> getBudingAllOders() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
            'https://api.thebharatworks.com/api/emergency-order/getAllEmergencyOrdersByRole'),
        headers: {
          'Authorization': 'Bearer $token',
          'Content-Type': 'application/json',
        },
  ...
  Widget _buildBudingCard(BudingData) {
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            // 👇 yaha condition lagayi hai
            if (BudingData.isEmpty)
              Center(
