...
//     // Get the latest status from offer_history if available
//     String displayStatus = data.status;
//     if (data.offer_history != null && data.offer_history!.isNotEmpty) {
//       displayStatus = data.offer_history!.last.status ?? data.status;
//     }
//
//     // Check if user_id and profile_pic exist and are valid
...
//             hasImage
//                 ? Image.network(
//               data.image, // Use data.image directly
//               height: 110,
//               width: 110,
//               fit: BoxFit.cover,
//               errorBuilder:
          ...
          ClipRRect(
            ...
            child: hasImage
              ...
              errorBuilder: (context, error, stackTrace) =>
                  Image.asset('assets/images/task.png', height: 110, width: 110, fit: BoxFit.cover),
            )
                : Image.asset('assets/images/task.png', height: 110, width: 110, fit: BoxFit.cover),
          ),
          const SizedBox(width: 10),
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text(
                  "Deadline: ${data.deadline != null ? data.deadline!.toLocal().toString().split('T').first : 'N/A'}",
                  style: _cardDate(),
                ),
                const SizedBox(height: 6),
                Row(
