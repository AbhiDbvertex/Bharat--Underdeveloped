    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (decoded['data']?['order']?['offer_history'] != null &&
          ...
          ['provider_id']['_id']?.toString();
          categoryId = decoded['data']['order']['offer_history'][0]
          ['provider_id']['category_id']?['_id']?.toString();
          subcategoryId =
...
// Yeh function InkWell ke onTap mein call hota hai
  ...
  Widget build(BuildContext context) {
    ...
    print("📋 Category ID get : status : $status");
    // print("📋 DirectViewScreen detail screen status: ${order?['offer_history']?['status'] }");
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text("The order is rejected by me",style: TextStyle(color: Colors.red),),
                              ],
                            ),
                          ),
                        ),
                      ...
                      if (_isOrderAccepted || order?['hire_status'] == 'cancelledDispute' || order?['hire_status'] == 'cancelled' || order?['hire_status'] == 'completed' ) ...[
                        Container(
                          height: 120,
                          width: double.infinity,
                          decoration: BoxDecoration(
                        ...
                        //     ),
                        //   ),
                        // ) : order?['hire_status'] == 'cancelledDispute' Center(
                        //   child: Container(
                        //     height: 40,
                        //     width: double.infinity,
                        ...
                        status == 'rejected'
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(Icons.block, color: Colors.red),
                                Text("The order is rejected by me",
