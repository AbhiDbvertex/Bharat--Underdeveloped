                  ...
                  data.map((e) {
                    ...
                    return /*DirectOrder(
                      ...
                      DirectOrder(
                        ...
                        date: order.date,
                        status: finalStatus, // Override status
                        image: (order.offer_history != null && order.offer_history!.isNotEmpty)
                            ? order.offer_history!.first.provider_id?.profile_pic ?? order.image
                            : order.image, // first offer ka provider image ya default order image
                        user_id: order.user_id,
