...
class _AccountScreenState extends State<AccountScreen> {
  ...
  Future<void> _fetchProfileData() async {
    try {
      ...
      print("Abhi:- print token get profile : $token");
  ...
  Future<void> Logout () async {
    try {
      ...
      print("Abhi:- print token get logout : $token");
      // Apna actual API endpoint daalo
      final String profileUrl = "https://api.thebharatworks.com/api/user/logout";
      ...
      if(response.statusCode == 200 || response.statusCode == 201){
        print("Abhi:- get logout api statusCode ${response.body}");
        print("Abhi:- get logout api statusCode ${response.statusCode}");
      }else{}
      print("Abhi:- else get logout api statusCode ${response.body}");
      print("Abhi:- else get logout api statusCode ${response.statusCode}");
    }catch(e){
      print("Abhi:- Get Execution in logout $e");
    }
}
