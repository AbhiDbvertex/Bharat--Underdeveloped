...
// import 'both_profile_screen.dart';
//
// class ProfileScreen extends StatefulWidget {
//   final swithcrole;
//   const ProfileScreen({super.key, this.swithcrole});
...
//   String? requestStatus;
//   String? role = 'No role';
//   String? verificationStatus = 'No status';
//   String? aboutUs = '';
//   String? phone;
//   String? selectedGender;
...
//   }
//   //           loader and class check code added
//   bool isLoading = true;
...
//
//     print("Abhi:- Checking in _initializeWithChecks - Role: $currentRole, VerifiedStatus: $verificationStatus");
//
//     // Conditions check kar
//     if (currentRole == "service_provider" && verificationStatus != null) {
//       if (verificationStatus == 'pending' || verificationStatus == 'rejected') {
//         // Pending ya rejected: FirstTimeServiceProviderProfileScreen pe bhej
//         print("Abhi:- Navigating to FirstTimeServiceProviderProfileScreen (pending/rejected)");
//         Get.off(() => FirstTimeServiceProviderProfileScreen());
...
//         return; // Navigation ke baad return
//       }
//     } else if (currentRole == "user" && verificationStatus == 'rejected'){
//       FirstTimeServiceProviderProfileScreen();
//     } else if(currentRole == "user") {
//       // User role: ProfileScreen pe reh (no navigation)
//       print("Abhi:- Staying on ProfileScreen (user)");
...
//     }
//
//     // Agar koi condition match nahi ya user role hai, toh ProfileScreen pe reh aur UI build kar
//     setState(() {
...
//
//
//           print("Abhi:- User Age: $userAge, Gender: $userGender verificationStatus : $verificationStatus");
//         }
//       }
//     } catch (e) {
//       debugPrint('❌ fetchProfileFromAPI Error: $e');
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _onRefresh() async {
    ...
    // Force loader off if no navigation
    if (mounted) { // Check if widget still alive
 ...
 /* Future<void> _initializeWithChecks() async {
    ...
    // Loader on rakha hai already, yahan check kar
    if (currentRole == "user" && (verificationStatus == 'rejected' || verificationStatus == 'pending')) {
      print("Abhi:- Navigating to FirstTimeServiceProviderProfileScreen");
      Get.off(() => FirstTimeServiceProviderProfileScreen()); // Proper navigation
      return; // Function exit kar de, no need for further code
    } else {
      // Sab theek hai (verified ya service_provider), ProfileScreen pe reh
      print("Abhi:- Staying on ProfileScreen");
      // Yahan SellerScreen mat daal, agar chahiye toh conditional daal
      // Example: if (currentRole == "service_provider") { Get.off(() => SellerScreen()); }
    }

    // Sirf yahan tak pahuncha matlab no navigation, loader off kar
    setState(() {
      isLoading = false; // Loader off
    });
  }*/
  ...
  Future<void> _initializeWithChecks() async {
    ...
    if (currentRole == "service_provider" && verificationStatus == 'verified') {
      print("Abhi:- Navigating to SellerScreen");
      Get.off(() => SellerScreen());
      return;
    }
