...
class _FirstTimeServiceProviderProfileScreenState extends State<FirstTimeServiceProviderProfileScreen> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (body['status'] == true) {
          ...
          print("Abhi:- User Age: $userAge, Gender: $userGender verifiedSataus : $verifiedSataus categoriy name : $category_name");
        }
      }
    } catch (e) {
  ...
  Widget _buildHeader(BuildContext context, String? selectedRole, String? requestStatus , bool verifiedSataus ,String category_name) {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(child: _buildRoleSwitcher(context,role,requestStatus,verifiedSataus,category_name))
          ],
        ),
      ),
    );
          ...
          child: ConstrainedBox(
            ...
            child: Stack(
              ...
              children: [
                ...
                _buildHeader(context, selectedRole,requestStatus,verifiedSataus ?? false,category_name!),
